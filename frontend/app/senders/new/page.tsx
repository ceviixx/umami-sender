          ...
          <label className="flex items-center cursor-pointer">
            <div className="relative">
              <input
                ...
                className="sr-only"
              />
              <div className={`w-10 h-6 bg-gray-300 rounded-full transition-colors ${form.use_auth ? 'bg-green-500' : ''}`}></div>
              <div
            ...
            <span className="ml-3 text-sm">{locale.forms.labels.auth_required}</span>
          </label>
        </div>
